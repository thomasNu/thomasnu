...
// Include Flexforms
// $TCA['tt_content']['types']['list']['subtypes_addlist'][$_EXTKEY . '_content'] = 'pi_flexform';
// t3lib_extMgm::addPiFlexFormValue($_EXTKEY . '_content', 'FILE:EXT:' . $_EXTKEY .'/Configuration/FlexForms/content.xml');
